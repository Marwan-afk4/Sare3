...
class UpdateDriverRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'new_password.min' => __('The Password must be at least 8 characters.'),
            'new_password.string' => __('The Password must be a string.'),
            'new_password.confirmed' => __('The Password confirmation does not match.'),
