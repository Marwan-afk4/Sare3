...
class UpdateDriverRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'password' => [
                Rule::excludeIf(fn () => $this->has('remove_password')),
                'nullable',
    ...
    public function messages()
    {
        return [
            ...
            'password.required_with' => __('The Password field is required when Confirm New Password is present.'),
            'password_confirmation.required_with' => __('The Confirm New Password field is required when Password is present.'),
