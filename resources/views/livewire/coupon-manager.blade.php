        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <input wire:model.live="search" type="text" class="form-control" placeholder="Search coupons...">
                        </div>
                        <div class="col-md-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button wire:click="editCoupon({{ $coupon->id }})" class="btn btn-sm btn-info">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $editMode ? 'Edit' : 'Add New' }} Coupon</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input wire:model="usage_limit" type="number" 
                                               class="form-control" placeholder="Leave empty for unlimited">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
