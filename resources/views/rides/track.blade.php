...
@section('content')
    ...
    @push('scripts')
        ...
        @php
            // Built as plain PHP (not one giant inline @json expression) — a
            // long nested ternary/array literal inside a single @json(...)
            // directive can exceed Blade's directive-parsing regex limits
            // and get silently truncated, producing invalid JS/PHP on render.
