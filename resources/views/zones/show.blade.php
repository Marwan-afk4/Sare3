            ...
            <div class="card">
              ...
                        @endif
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="mt-2">
                                <small class="text-muted">{{ __('From') }}: {{ $zone->from_lat }}, {{ $zone->from_lng }}</small><br>
                                <small class="text-muted">{{ __('To') }}: {{ $zone->to_lat }}, {{ $zone->to_lng }}</small>
                            </div>
                        </li>
                        @endif
                        <li class="list-group-item d-flex justify-content-between">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group btn-group-sm">
                        <button type="button" class="btn btn-outline-primary" id="fitBounds">{{ __('Fit to Zone') }}</button>
                        <button type="button" class="btn btn-outline-secondary" id="toggleSatellite">{{ __('Satellite') }}</button>
                    </div>
                </div>
...
function initZoneMap() {
    ...
    try {
        ...
        if (typeof google === 'undefined' || typeof google.maps === 'undefined') {
            ...
            document.getElementById('zoneMap').innerHTML = '<div class="alert alert-danger m-3">Google Maps failed to load. Please check your API key and internet connection.</div>';
            return;
        }

        // Default center
        let mapCenter = { lat: 24.7136, lng: 46.6753 }; // Riyadh, Saudi Arabia
        let mapZoom = 11;
        ...
        document.getElementById('zoneMap').innerHTML = '<div class="alert alert-danger m-3">Error loading map: ' + error.message + '</div>';
    }
}
...
window.gm_authFailure = function() {
    ...
    document.getElementById('zoneMap').innerHTML = '<div class="alert alert-danger m-3">Google Maps authentication failed. Please check your API key.</div>';
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        if (typeof map === 'undefined' && typeof google !== 'undefined' && typeof google.maps !== 'undefined') {
