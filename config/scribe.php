...
// Note: Scribe is a dev-only package. Config uses plain values to avoid class-not-found errors in production.
...
return [
    ...
    // (Only used when Scribe is installed — dev environments)
